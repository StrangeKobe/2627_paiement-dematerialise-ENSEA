...
class Affectation(models.Model):
    ...
    # pour eux). Accordes au cas par cas depuis la page Equipe : un Admin
    # de pole peut accorder les droits normaux a ses propres vendeurs,
    # y compris "adhesion en especes". Seul un Admin ADE peut accorder
    # "recharger en especes" (le portefeuille, qui donne aussi
    # automatiquement acces au suivi especes correspondant : voir le
    # suivi sans pouvoir recharger n'aurait aucun interet).
