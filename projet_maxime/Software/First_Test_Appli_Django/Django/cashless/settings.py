...
SECRET_KEY = 'django-insecure-$tgp#2j(&6%_5_vjr9yuntc*0mrj#&cljmy8k7^f_g$(toa@&u'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# "*" est sans risque ici uniquement parce que DEBUG=True et que le serveur
# de developpement n'est jamais expose au-dela du reseau local : ca permet
# d'ouvrir l'appli depuis un telephone sur le meme reseau. A restreindre a
# une vraie liste de domaines le jour du deploiement en production.
ALLOWED_HOSTS = ["*"]
...
# Google affiche le mot de passe d'application avec des espaces (par
# lisibilite) ; on les retire ici pour accepter le copier-coller tel quel,
